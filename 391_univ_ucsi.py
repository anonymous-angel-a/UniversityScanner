...
def ucsi():
    url = "https://www.ucsiuniversity.edu.my/staff/Institute-of-Computer-Science-and-Digital-Innovation/Kuala-Lumpur"   # homepage url
    ...
    for i in dd:
        ...
        link = "https://www.ucsiuniversity.edu.my"+ a.get('href')                # extracting prof page link
