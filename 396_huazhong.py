...
def huazhong():
    url = "http://english.cs.hust.edu.cn/Faculty.htm"   # homepage url
    ...
    filename = "huazhong.txt"
    f = open(filename, "w")

    excel_filename = "huazhong.csv"
    ...
    u_name = "Huazhong University of Science and Technology"
    ...
    d = soup.find_all('span', {'class': 'snm'})
    dd = []
    for i in d:
        d1 = i.find_all('a')
        dd.extend(d1)
    ...
    for i in dd:
        ...
        a = i.find('span')                     # a contains the name and the homepage of prof
