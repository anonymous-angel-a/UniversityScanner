...
def shanghai():
    url = "https://www.cs.sjtu.edu.cn/en/Faculty.aspx"   # homepage url
    ...
    d = soup.find_all('div', {'class': 'Faculty'})
    dd = []
    for i in d:
        d1 = i.find_all('a')
        dd.extend(d1)
    ...
    for i in dd:
        a = i
        link = "https://www.cs.sjtu.edu.cn/en/"+ a.get('href')                # extracting prof page link
