...
def lincoln():
    url = "https://www.lincoln.ac.uk/socs/staffcontactlist/"   # homepage url
    ...
    for i in dd:
        ...
        name = a[0].get_text()                 # extracting prof name
        email = a[1].get_text()
