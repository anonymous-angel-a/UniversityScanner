...
def taipei():
    url = "https://csie.ntut.edu.tw/csie/English/faculty/faculty_all.html"   # homepage url
    ...
    u_name = "Taipei Medical University (TMU)"
    country = "Taiwan"
    ...
    for i in dd:
        ...
        #print(a)
        link = "https://csie.ntut.edu.tw/csie/English/faculty/" + a.get('href')                # extracting prof page link
        name = a.get_text()                 # extracting prof name
        e = i.find('font', {'color' : '#007bff'})
        email = ""
        if e == None:
            email = "Not Found"
        else:
